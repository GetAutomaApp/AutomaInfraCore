...
internal extension ImageGenerationClientBase {
    ...
    func generateImage(_ query: Self.GenerateImageQuery) async throws -> Self.GenerateImageResult
    ...
    public struct GenerateImageQuery: Content {
        ...
        public let model: Self.GenerateImageModel
        ...
        public let quality: Self.GenerateImageQuality?
        ...
        public init(
            model: Self.GenerateImageModel,
            prompt: String,
            totalImagesToGenerate: Int? = nil,
            quality: Self.GenerateImageQuality? = nil,
            imageSize: Self.GenerateImageSize? = nil,
            imageStyle: Self.GenerateImageStyle? = nil
        ) {
            self.model = model
            self.prompt = prompt
    ...
    public enum GenerateImageModel: String, Codable {
    ...
    public enum GenerateImageQuality: String, Codable {
