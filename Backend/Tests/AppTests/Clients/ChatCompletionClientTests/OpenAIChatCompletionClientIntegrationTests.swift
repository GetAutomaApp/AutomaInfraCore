// OpenAIChatCompletionClientIntegrationTests.swift
...
@Suite("OpenAIChatCompletionClientIntegrationTests")
internal struct OpenAIChatCompletionClientIntegrationTests: ChatCompletionClientTestSuite {
