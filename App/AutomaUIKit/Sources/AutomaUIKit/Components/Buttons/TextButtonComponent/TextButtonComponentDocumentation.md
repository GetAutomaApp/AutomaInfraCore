...
|----------|------|-------------|
| `config` | TextButtonComponentConfig | Configuration for the component. |

## Guidelines
<!-- Explain when and when not to use the component based on past experience -->

## Customization
<!-- Explain how users can customize the component via the "Config" object in TextButtonComponentConfig Struct -->
